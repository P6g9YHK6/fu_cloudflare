...
class Fu_Cloudflare extends Plugin {
	...
	// Update checker removed for production
	...
	function hook_prefs_tab($args) {
		...
		<div dojoType='dijit.layout.AccordionPane'
			...
			<div style='display: flex; justify-content: space-between; align-items: center; font-size: 0.85em; margin-top: 12px'>
				<span class='text-muted' id='fu_version_info'></span>
				<span><a href='#' onclick='Plugins.Fu_Cloudflare.checkVersion(); return false;'>Check now</a></span>
			</div>
			-->
		</div>
